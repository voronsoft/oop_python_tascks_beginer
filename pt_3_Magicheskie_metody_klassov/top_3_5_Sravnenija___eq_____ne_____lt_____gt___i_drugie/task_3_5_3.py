...
где start_x, start_y - локальные атрибуты экземпляра класса, координаты начала маршрута (целые или вещественные числа).
...
from test3_5.test_3_5_3 import test_3

test_3(Track, TrackLine, track1, track2, res_eq)
# END
