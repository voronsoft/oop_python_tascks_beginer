...
Подвиг 6. Вам дают задание разработать итератор для последовательного перебора элементов
...
from test3_9.test_3_9_6 import test_6

test_6(TriangleListIterator)
# END
