...
# descriptor
class PriceValue:
    """Класс PriceValue должен проверять, что вещественное или целочисленное значение в диапазоне [0; 10000],
    т.е. max_value = 10000. Если проверки не проходят, то соответствующие (прежние) значения меняться не должны."""
...
from test2_3.test_2_3_8 import test_8

test_8(SuperShop, Product)
# END
