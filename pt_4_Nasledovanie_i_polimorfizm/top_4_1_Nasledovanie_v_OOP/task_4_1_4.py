...
get_info() - для получения информации о животном. Этот метод должен возвращать строку в формате:
...
class Cat(Animal):
    ...
    # Наконец, в классах Cat объявите метод:
    # get_info() - для получения информации о животном. Этот метод должен возвращать строку в формате:
    # "name: old, <остальные параметры через запятую>"
    # Например, для следующего объекта класса Cat:
    # cat = Cat('кот', 4, 'black', 2.25)
...
class Dog(Animal):
    def __init__(self, name, old, breed, size):
        ...
        if all(i for i in size if i in (int, float)):
            self.size = size[0], size[1]  # size - кортеж в формате (height, length) высота и длина - числа
        else:
            self.size = None

    # Наконец, в классах Dog объявите метод:
    # get_info() - для получения информации о животном. Этот метод должен возвращать строку в формате:
    # "name: old, <остальные параметры через запятую>"
    # Например, для следующего объекта класса Cat:
    # cat = Cat('кот', 4, 'black', 2.25)
...
from test4_1.test_4_1_4 import test_4

test_4(Cat, Animal, Dog)
# END
