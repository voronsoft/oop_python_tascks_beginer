...
# assert isinstance(f1, Mechanical) and isinstance(f2, Aragon) and isinstance(f3, Calcium), "фильтры должны быть установлены в порядке: Mechanical, Aragon, Calcium"
# #
