...
# Объявите класс с именем MediaPlayer
class MediaPlayer:
    filename = 'file'

    # с двумя методами:
    # для открытия медиа-файла с именем file
    # (создает локальное свойство filename со значением аргумента file в объекте класса MediaPlayer)
    def open(self, filename='file'):
        # filename = 'file'
        self.filename = filename

    # для воспроизведения медиа-файла (выводит на экран строку "Воспроизведение <название медиа-файла>")
    def play(self):
