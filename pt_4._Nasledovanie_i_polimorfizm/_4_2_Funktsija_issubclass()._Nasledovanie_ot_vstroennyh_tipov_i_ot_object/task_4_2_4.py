...
dict_things = DictShop(things) # словарь с набором словаря things (где things - некоторый словарь).
...
class Thing:
    ...
    def __init__(self, name, price, weight):
        ...
        self.price = float(price)  # цена (вещественное число)
...
# raise TypeError('ключами могут быть только объекты класса Thing')
class DictShop(dict):
    """Класс словаря унаследованный от dict"""
